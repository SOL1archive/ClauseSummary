...
def split_to_unit(full_doc: list):
    # 목차를 지정하는 키워드 저장
    with open('C:\\Users\\jeff4\Downloads\\ClauseSummary-main\\parser-v0.1\\index.csv', 'r', encoding='utf-8') as f:
        index_name_lt = []
    ...
    print(f"index_pages: {len(index_pages)} result_doc: {len(result_doc)}")
    return result_doc
